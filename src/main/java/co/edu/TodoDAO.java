...
//	      connect();
//	      String sql = "INSERT INTO todo_list VALUES(TODO_SEQ.NEXTVAL, ?, 'N')";
//	      try {
//	         psmt = conn.prepareStatement(sql);
...
//	 }
//	 
//	 public void checklist(Todo td) {
//		 connect();
//		 String sql = "Update todo_list set status = 'Y' where = ?";
//		 try {
//			psmt = conn.prepareStatement(sql);
//			psmt.setInt(1, td.getId());
//			psmt.executeUpdate();
