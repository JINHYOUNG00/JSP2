...
//		if (req.getParameter("cmd").equals("insert")) {
//			Todo td = new Todo();
//			td.setContent(req.getParameter("content")); // html에서 받아온 content를 할당시키고
//			dao.insertlist(td); // DAO에 던져주고 DB입력한 뒤, 선물로 todoId값을 받아온다.
//			Gson gson = new GsonBuilder().create();
//			resp.getWriter().print(gson.toJson(td)); // todoId 실고 다시 html로 떠남
//		}
//		if (req.getParameter("cmd").equals("delete")) {
//			Todo td = new Todo();
//			td.setId(Integer.parseInt(req.getParameter("Id")));
//			dao.deletelist(td);
//
//		}
//		if (req.getParameter("cmd").equals("modify")) {
//			Todo td = new Todo();
//			td.setStatus(req.getParameter("checked"));
//			td.setId(Integer.parseInt(req.getParameter("todoId")));
//			dao.checklist(td);
//		}
//
//
